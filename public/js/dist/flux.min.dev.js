...
(function (b) {
  flux.slider = function (c, e) {
    ...
    this.image1 = b('<div class="image1" style="height: 15%; width: 100%"></div>').appendTo(this.imageContainer);
    this.image2 = b('<div class="image2" style="height: 15%; width: 100%"></div>').appendTo(this.imageContainer);
  ...
  flux.slider.prototype = {
    ...
    next: function next(c, e) {
      e = e || {};
      e.direction = "left";
      this.showImage(this.currentImageIndex + 1, c, e);
    },
    prev: function prev(c, e) {
      e = e || {};
      e.direction = "right";
      this.showImage(this.currentImageIndex - 1, c, e);
    },
    showImage: function showImage(c, e, a) {
      this.setNextIndex(c);
      this.setupImages();
      this.transition(e, a);
    },
    finishedLoading: function finishedLoading() {
      ...
      if (this.options.controls) {
        ...
        this.nextButton = b("<a href=\"#\">\xBB</a>").css(e).css3({
          "border-radius": "4px"
        }).appendTo(this.surface).bind("click", function (a) {
          a.preventDefault();
          c.next();
        });
        this.prevButton = b("<a href=\"#\">\xAB</a>").css(e).css3({
          "border-radius": "4px"
        }).appendTo(this.surface).bind("click", function (a) {
          a.preventDefault();
          c.prev();
    ...
    transition: function transition(c, e) {
    ...
    setNextIndex: function setNextIndex(c) {
...
(function (b) {
  flux.browser = {
    ...
    supportsCSSProperty: function supportsCSSProperty(c) {
...
(function (b) {
  flux.transitions.bars = function (c, e) {
    return new flux.transition_grid(c, b.extend({
      ...
      rows: 1,
      delayBetweenBars: 40,
      renderTile: function renderTile(a, d, f, g, h, i) {
        b(a).css({
...
(function (b) {
  flux.transitions.blocks = function (c, e) {
    return new flux.transition_grid(c, b.extend({
      ...
      renderTile: function renderTile(a, d, f, g, h, i, j) {
...
(function (b) {
  flux.transitions.cube = function (c, e) {
    return new flux.transition(c, b.extend({
      ...
      transitionStrings: function transitionStrings(a, d) {
